...
import { deleteBookmark, deleteList, setBookmark, setList } from '../../redux/listOperationsSlice';
    ...
    <div className='absolute top-[40px] right-1 min-w-[300px] modal-class'>
        <div className="w-full max-w-md p-4 border rounded-lg shadow sm:p-8 bg-gray-800 border-gray-700">
            <div className="flex items-center justify-between mb-4">
                <h5 className="text-xl font-bold leading-none  text-white">Latest Customers</h5>
                  ...
                  movie.map(movieDetail =>(
                        ...
                        <div className="flex items-center">
                            <div className="flex-shrink-0">
                                <img className="w-8 h-8 rounded-full" src={`https://image.tmdb.org/t/p/original/${movieDetail.poster_path}`} alt=""/>
                            </div>
                            ...
                            <div onClick={()=>deleteMovie(movieDetail.id)} className="inline-flex items-center justify-center text-xl text-base font-semibold text-gray-900 dark:text-white w-8 h-8 cursor-pointer hover:text-[#1A98FF]">
                                <MdDeleteOutline />
                            </div>
                        </div>
                    </li> 
                    ...
                    : 
                <li className='text-sm text-gray-500 '>There is no movie to show</li>    
                }
                </ul>
        </div>
        </div>
